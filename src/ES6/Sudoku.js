class Sudoku extends Global {
    constructor (options) {
        ...
        this._jumpIndex = options.jumpIndex || Math.floor(Math.random() * this.AWARDS_LEN);
        this._jumpingTime = 0;
        this._jumpTotalTime;
        this._jumpChange;
        ...
        if (this.hasButton === 'true') {
            ...
            ['mousedown', 'touchstart'].forEach((event) => {
                canvas.addEventListener(event, (e) => {
                    ...
                    if (context.isPointInPath(loc.x * ratio, loc.y * ratio) && !this._isAnimate) {
